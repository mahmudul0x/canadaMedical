...
export const Route = createFileRoute("/testimonials")({
  head: () => ({ meta: [{ title: "Physician Testimonials — CandianMdJobs" }] }),
  component: TestimonialsPage,
});

const items = [
  { name: "Dr. Sarah Mitchell", role: "Family Physician — Calgary, AB", quote: "CandianMdJobs helped me transition from a busy Toronto hospital to a rewarding rural practice. The team handled every detail — from licensing to housing referrals." },
  ...
  { name: "Dr. James Wong", role: "General Surgeon — Edmonton, AB", quote: "After 12 years in academic medicine, CandianMdJobs helped me find a community hospital that fit my new chapter perfectly." },
];
