  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 lg:px-8">
        <div className="grid gap-6 rounded-3xl border border-border bg-secondary/60 p-5 sm:p-8 lg:grid-cols-3 lg:p-12">
          {[
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 lg:px-8">
        <div className="rounded-3xl bg-linear-to-br from-primary to-primary-glow p-6 text-center text-primary-foreground shadow-(--shadow-elegant) sm:p-10 lg:p-14">
          ...
          {isLoading
            ...
            : (plans ?? []).map((plan) => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`relative flex flex-col rounded-2xl border p-5 sm:p-8 transition ${
                      isPopular
